...
export default function HeroSection() {
  const heading = "Junagarh  Fort".split("");
  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4">
        ...
        >
          The Unconquered Jewel of Bikaner
        </motion.p>
        ...
        <motion.h1
          ...
          initial="hidden"
          animate="visible"
          className="text-yellow-500 text-5xl md:text-[100px] lg:text-[160px] font-semibold tracking-wider flex justify-center"
        >
